...
This project has developer-prepared documentation and tests, not an independent security assessment or institutional approval. Windows 2.1.0 is unsigned. Follow your institution's decision before using sensitive, confidential, or regulated documents.
...
Windows 2.1.0's guided workspace uses bundled assets, a sandboxed renderer, a nonpersistent session and blocked external renderer requests. The native helper and Microsoft Office conversion are separate processes; Office/OS temporary files and network behavior are outside those renderer controls.
...
- [Browser review package](https://github.com/BelovedCoachP/pixel-perfect-clone-31624-c9233ca7/tree/main/docs/security)
- [Windows review package](https://github.com/BelovedCoachP/pdf-remediator/tree/main/docs/security)
- [Windows releases](https://github.com/BelovedCoachP/pdf-remediator-app/releases)
...
Release checksums verify integrity against a published value; they do not replace publisher signing. Do not bypass institutional installation restrictions. Windows has no automatic updater.


Windows 2.1.0 includes the current guided PDF repair workflows and conservative native safeguards. Its dependency-security and native regression checks passed on September 15, 2026. Packaged synthetic workflow checks also passed. These are developer evidence, not institutional approval or a guarantee for arbitrary documents.
